package com.gerberdshild.javalanguage.multithreadedprogramming.golovach_06;
...
public class DeadlockTwo {
    public static void main(String[] args) {
        ...
        //далее планировщих ОС выбирает когда какому потоку стартовать, в зависимости от наличия свободных ядер
        threads[0].start();
        threads[1].start();
